const spideymoji = {
    ...
    init: function(button) {
        button.innerHTML = this.buildSpideymojiHtml();
        this.addEventListeners(button,true);
        document.querySelectorAll('.spidey-reaction')
        .forEach(spideyReaction => this.addEventListeners(spideyReaction,false));
    },

    buildSpideymojiHtml: function() {
    ...
    mouseenterEventListener: function(target, isMainButton) {
    ...
    mouseleaveEventListener: function(target, isMainButton) {
    ...
    clickEventListener: function(target, isMainButton) {
    ...
    addEventListeners: function(target, isMainButton) {
        this.mouseenterEventListener(target, isMainButton);
        this.mouseleaveEventListener(target, isMainButton);
        this.clickEventListener(target, isMainButton);
    }
}

document.querySelectorAll(".spideymoji")
.forEach(spideyButton => spideymoji.init(spideyButton));